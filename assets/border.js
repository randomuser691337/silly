...
<body style="width: 100vw; height: 100vh; display: flex; justify-content: flex-start; align-items: center; overflow: hidden; margin-left: 50px; color: white; background: rgb(255, 204, 77)">
    <div id="centered">
